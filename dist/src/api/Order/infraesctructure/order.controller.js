...
function deleteOrderById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield addStockOfProducts(String(getter.product['id']));
...
function subtractStockOfProducts(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (getter) {
            yield product_models_1.ProductModel.findByIdAndUpdate(getter._id, { $set: { inStock: getter.inStock - getter.cantToBuy } });
        }
    });
}
