...
router
    .get('/pendingAll/:pending', checkAuth_1.checkAuth, sales_controllers_1.SalesControllers.getAllSalesPending)
    ...
    .put('/:id', checkAuth_1.checkAuth, sales_controllers_1.SalesControllers.markSaleAsFinished)
